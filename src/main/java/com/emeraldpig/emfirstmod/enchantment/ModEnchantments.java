package com.emeraldpig.emfirstmod.enchantment;

import com.emeraldpig.emfirstmod.EmFirstMod;
import com.emeraldpig.emfirstmod.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantments {
    public static final ResourceKey<Enchantment> LIGHTNING_STRIKER = ResourceKey.create(Registries.ENCHANTMENT,
            ResourceLocation.fromNamespaceAndPath(EmFirstMod.MOD_ID, "lightning_striker"));

    public static final ResourceKey<Enchantment> VEIN_MINER = ResourceKey.create(Registries.ENCHANTMENT,
            ResourceLocation.fromNamespaceAndPath(EmFirstMod.MOD_ID, "vein_miner"));

    public static final ResourceKey<Enchantment> AUTO_SMELT = ResourceKey.create(Registries.ENCHANTMENT,
            ResourceLocation.fromNamespaceAndPath(EmFirstMod.MOD_ID, "auto_smelt"));
